...
class AppHaptics{
  ...
  static Future<void> textEditingImpact()async{
    final canVibrate = await _canAppVibrate();
    if(!canVibrate){
      return;
    }
  ...
  static Future<void> attentionImpact()async{
    final canVibrate = await _canAppVibrate();
    if(!canVibrate){
      return;
    }
  ...
  static Future<void> attentionLightImpact()async{
    final canVibrate = await _canAppVibrate();
    if(!canVibrate){
      return;
    }
  ...
  static Future<void> bounceImpact()async{
    final canVibrate = await _canAppVibrate();
    if(!canVibrate){
      return;
    }
